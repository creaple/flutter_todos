...
class SearchAndFilterTodo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        TextField(
          decoration: const InputDecoration(labelText: 'Search todos', border: InputBorder.none, filled: true, prefixIcon: Icon(Icons.search)),
...
class ShowTodos extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final todos = context.read<FilteredTodos>().state.filteredTodos;
